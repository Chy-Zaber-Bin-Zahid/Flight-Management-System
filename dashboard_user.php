...
<html lang="en">
  ...
  <body>
    ...
    <section class="sec-2">
        <div class="option">
            <div style ="border: 1px dotted yellow; padding: .3em 0em; background-color: gray;" class="adjust"><a href="history_user.php">History</a></div>
            <div style ="border: 1px dotted yellow; padding: .3em 0em; background-color: gray;" class="adjust"><a href="available.php">Available Ticket</a></div>
        </div>
